...
public class SpellAndEffectLoader : MonoBehaviour {
	...
	void Awake (){
		...
		EffectsOnTime.Add (new EffectOnTime ("renovation","First HoT of the game",true,3,10,1,new StatEffect(new Dictionary<Stat,float>{{Stat.maxSpeed,100f}}),newHealOnTime(new Dictionary<Stat,float>{{Stat.intelligence,1.6f}},50)));
