...
public class SpellAndEffectLoader : MonoBehaviour {
	...
	void Awake (){
		EffectsOnTime.Add (new EffectOnTime ("corruption","First DoT of the game",false,6,0.5f,30,0));
		EffectsOnTime.Add (new EffectOnTime ("renovation","First HoT of the game",true,10,1,0,50));


		Spells.Add (new HostileSpell ("fireball","A magic Fireball. That's it.", 10,2,25,0,0));
		Spells.Add (new HostileSpell ("pewpewlazer","kikoolol",10,0.5f,100,1,5));
