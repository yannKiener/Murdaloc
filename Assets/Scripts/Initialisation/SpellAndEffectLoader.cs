...
public class SpellAndEffectLoader : MonoBehaviour {
    ...
    private void CreateSpells()
    {
        ...
        CreateHostileSpell("Rend", "Wounds the target causing them to bleed, dealing damage.", 10, 0f, 2, 0, Constants.MaxAutoAttackDistance, true, newDamage(new Dictionary<Stat, float> { { Stat.force, 0.4f } }, 1), "Bloody", getEffect("Rend"), null);
